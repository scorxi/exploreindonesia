...
<head>
    ...
    <title>Kecamatan Wisata - ADMIN</title>
</head>
...
<div class="container-fluid">
    <div class="card shadow mb-4">
        ...
        <?php die("anda harus mengisi data");
            ...
            mysqli_query($connection, "insert into kecamatan values ('$kodeKec', '$namaKec', '$ketKec', '$kodeProv')");
            ...
            <div class="col-sm-10">
                ...
                <form method="POST">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="kodeKecamatan" name="inputKode" maxlength="4" required="" placeholder="No. Kecamatan (Max : 4 Karakter)">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="namaKecamatan" class="col-sm-2 col-form-label">Nama Kecamatan</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="namaKecamatan" name="inputNama" required="" placeholder="Nama Kecamatan">
                        </div>
                    </div>
                    <div class="form-group row">
