...
<head>
    ...
    <title>Edit Kabupaten Wisata - ADMIN</title>
</head>
...
<div class="container-fluid">
    <div class="card shadow mb-4">
        ...
        <?php die("anda harus mengisi data");
            ...
            mysqli_query($connection, "update kabupaten set Nama_Kabupaten = '$namaKab', Keterangan = '$ketKab', provinsiID = '$kodeProv'
        ...
        $editProvinsi = mysqli_query($connection, "select * from kabupaten, provinsi
        where kabupatenID = '$kabupatenID'
            ...
            <div class="col-sm-10">
                ...
                <form method="POST">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="kodeKabupaten" name="inputKode" value="<?php echo $rowedit['kabupatenID'] ?>" maxlength="4" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="namaKabupaten" class="col-sm-2 col-form-label">Nama Kabupaten</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="namaKabupaten" name="inputNama" value="<?php echo $rowedit['Nama_Kabupaten'] ?>" required="">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select name="inputKodeProv" id="ref" class="form-control">
                                ...
                                <option value="<?php echo $roweditProv["provinsiID"] ?>">
