...
if (isset($_POST['Edit'])) {
    ...
    if (empty($nama)) {
        mysqli_query($connection, "update restoran set Nama_Restoran = '$namaResto', Alamat = '$alamat', areaID = '$kodeArea'
    ...
    if (($ekstensiFile == "jpg" || $ekstensiFile == "JPG" || $ekstensiFile == "png" || $ekstensiFile == "PNG")) {
        ...
        mysqli_query($connection, "update restoran set
        Nama_Restoran = '$namaResto', Alamat = '$alamat', areaID = '$kodeArea', Foto_Restoran = '$nama'
        where restoranID = '$kodeResto'");
    }
    header("location:restoran.php");
}
...
$restoKode = $_GET["ubahResto"];
$editResto = mysqli_query($connection, "select * from
restoran
where restoranID = '$restoKode'");
$rowedit = mysqli_fetch_array($editResto);

$editArea = mysqli_query($connection, "select *
from restoran, area
where restoranID = '$restoKode' and restoran.areaID = area.areaID");
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            <div class="jumbotron jumbotron-fluid">
                <div class="container">
                    <h1 class="display-4">Edit Restoran di Destinasi Wisata</h1>
                </div>
            </div>
            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="kodeRestoran" name="inputKode" value="<?php echo $rowedit['restoranID'] ?>" readonly required="" maxlength="4">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="namaRestoran" class="col-sm-2 col-form-label">Nama Restoran</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="namaResort" name="inputNama" value="<?php echo $rowedit['Nama_Restoran'] ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="alamatResto" class="col-sm-2 col-form-label">Alamat</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="alamatResto" name="inputAlamat" value="<?php echo $rowedit['Alamat'] ?>">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select name="inputArea" id="namaArea" class="form-control">
                            <option value="<?php echo $rowedit['restoranID'] ?>">
                                <?php echo $rowedit2['areaID'] . " " . $rowedit2['Nama_Area'] ?></option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <img src="img/<?php echo $rowedit['Foto_Restoran'] ?>" alt="" width="200px" height="100px">
