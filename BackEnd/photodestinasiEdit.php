...
<head>
    ...
    <title>Foto Destinasi Wisata - ADMIN</title>
...
if (isset($_POST['Edit'])) {
    ...
    if (empty($nama)) {
        mysqli_query($connection, "update fotodestinasi set Nama_Foto = '$namaFoto', destinasiID = '$kodedestinasi'
    ...
    if (($ekstensiFile == "jpg" || $ekstensiFile == "JPG" || $ekstensiFile == "png" || $ekstensiFile == "PNG")) {
        ...
        Nama_Foto = '$namaFoto', destinasiID = '$kodedestinasi', Foto_File = '$nama'
        where fotoID = '$kodeFoto'");
    }
    header("location:photodestinasi.php");
}
...
$fotoKode = $_GET["ubahFoto"];
$editFoto = mysqli_query($connection, "select * from
fotodestinasi
where fotoID = '$fotoKode'");
$rowedit = mysqli_fetch_array($editFoto);

$editdestinasi = mysqli_query($connection, "select *
from destinasi, fotodestinasi
where fotoID = '$fotoKode' and destinasi.destinasiID = fotodestinasi.destinasiID");
        ...
        <div class="col-sm-10">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="namaFoto" name="inputNama" value="<?php echo $rowedit["Nama_Foto"]; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select name="kodedestinasi" id="namaDestinasi" class="form-control">
                            <option value="<?php echo $rowedit["destinasiID"]; ?>">
                                <?php echo $rowedit["destinasiID"] . " " . $rowedit2["Nama_Destinasi"]; ?>
                            </option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <img src="img/<?php echo $rowedit["Foto_File"]; ?>" style="width: 200px; height: 100px;">
                    ...
                    while ($row = mysqli_fetch_array($query)) : ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php } else
                                    echo "<img src='img/Fabio.png' width='80'>";
                                ?>
